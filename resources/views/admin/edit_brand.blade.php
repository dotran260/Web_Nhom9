                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-block">
                                            <form action="{{URL::to('/update-brand/'.$value -> brand_id)}}" class="form-material" method="POST">
                                                {{csrf_field()}}
                                                <div class="form-group form-primary">
                                                    <input type="text" name="brand_name" class="form-control" value="{{$value -> brand_name}}">
                                                    <span class="form-bar"></span>
                                                    <label class="float-label">Tên danh mục</label>
                                                </div>
                                                <div class="form-group form-primary">
                                                    <textarea style="height:200px" class="form-control" name="brand_desc">{{$value -> brand_desc}}</textarea>
                                                    <span class="form-bar"></span>
                                                ...
                                                <div class="form-group row" style="justify-content:end">
                                                    <button type="submit" name="add_brand" class="btn btn-info waves-effect waves-light"><i class="fa-solid fa-circle-plus"></i>Update</button>
                                                </div>
                                            </form>
                                        </div>
                                        @endforeach
