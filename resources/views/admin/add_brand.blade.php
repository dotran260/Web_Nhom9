                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-block">
                                            <form action="{{URL::to('/save-brand')}}" class="form-material" method="POST">
                                                {{csrf_field()}}
                                                <div class="form-group form-primary">
                                                    <input type="text" name="brand_name" class="form-control">
                                                    <span class="form-bar"></span>
                                                    <label class="float-label">Tên thương hiệu</label>
                                                </div>
                                                <div class="form-group form-primary">
                                                    <textarea style="height:200px" class="form-control" name="brand_desc"></textarea>
                                                    <span class="form-bar"></span>
                                                    <label class="float-label">Mô tả thương hiệu</label>
                                                </div>
                                                <div class="form-group form-primary">
                                                    <input type="text" name="keywords" class="form-control">
                                                    <span class="form-bar"></span>
                                                    <label class="float-label">Từ khoá thương hiệu</label>
                                                </div>
                                                <div class="form-group row">
                                                    <label class="col-sm-2 col-form-label">Hiển thị</label>
                                                    <div class="col-sm-10">
                                                        <select name="brand_value" class="form-control fill" style="border-left:4px solid blue; background-color: #ddffff;">
                                                ...
                                                <div class="form-group row" style="justify-content:end">
                                                    <button type="submit" name="add_brand" class="btn btn-info waves-effect waves-light"><i class="fa-solid fa-circle-plus"></i>Thêm</button>
                                                </div>
                                            </form>
                                        </div>
                                    </div>
