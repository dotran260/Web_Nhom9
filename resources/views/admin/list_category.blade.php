                                ...
                                <div class="col-md-12">
                                    <div class="card">
                                        <div class="card-header">
                                            ...
                                            <span>List <code>category</code></span>
                                                ...
                                                <table class="table table-dark">
                                                    ...
                                                    <tbody>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <?php
                                                                if ($value->category_value == 1) {
                                                                ?>
                                                                    <a href="{{URL::to('/hidden-category/'.$value -> category_id)}}"><i style="font-size:30px;" class="fa-solid fa-toggle-on"></i></span></a>
                                                                <?php
                                                                } else {
                                                                ?>
                                                                    <a href="{{URL::to('/active-category/'.$value -> category_id)}}"><i style="font-size:30px;" class="fa-solid fa-toggle-off"></i></span></a>
                                                                <?php
                                                                }
                                                                ?>
                                                            </td>
                                                            <td style="display: flex;">
                                                                <a href="{{URL::to('admin/edit-category/'.$value -> category_id)}}" ui-toggle-class="">
                                                                    <i style="font-size:30px;margin-right:12px;" class="fas fa-edit text-success text-active"></i>
                                                                </a>
                                                                <a href="{{URL::to('/delete-category/'.$value -> category_id)}}" onclick="return confirm('Bạn có chắc là muốn xóa danh mục này không?')" ui-toggle-class="">
